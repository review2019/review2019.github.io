if(screen.width >= 750){
    ...
    */
    function updateEpoch(){
        currentEpoch = currentEpoch + ((25000))
    ...
    function bubbleChart(nodeColors) {
      ...
      var yearCenters = {
        ...
        'Distracting': { x: width / 2.5, y: height / 2.5 },
    ...
    function problem_demo(file_path){
        d3.json(file_path)
            .then(function(data) {
    ...
    function remove_problem_demo(){
        $('#vis').empty()
        $('#dropdownLegend').empty()
        $('#chooseFeature').empty()
    ...
    function setUpChart(data){
        ...
        startingEpoch = data[0].posted - (1000*60*60*1) // start hour early!
        currentEpoch = startingEpoch
        updateEpoch();
        /*
